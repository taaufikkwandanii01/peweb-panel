        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href={`/${userRole}/dashboard`} className="flex items-center gap-2">
              ...
              <span className="hidden sm:block text-xl font-bold text-gray-900">Panel</span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-blue-50 rounded-full">
              <span className="text-xs font-medium text-blue-700 uppercase">{userRole}</span>
            </div>

            {/* Notifications */}
            <button className="p-2 rounded-full text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 relative">
            ...
            <div className="relative">
              ...
              >
                ...
                <FaChevronDown className={`w-4 h-4 text-gray-600 transition-transform ${isProfileOpen ? 'rotate-180' : ''}`} />
              </button>
